      ...
      <div style={s.container}>
        <div style={s.card}>
          <div style={s.header}>
            ...
            <h1 style={s.title}>
              Daftar Akun <span style={s.titleGreen}>Baru</span>
            </h1>
            <p style={s.subtitle}>Bergabunglah bersama kami untuk lingkungan yang lebih bersih.</p>
          </div>
          ...
          <form action={action} style={s.form}>
            ...
            <div style={s.formGroup}>
              ...
              />
              {state?.errors?.nama && (
                <p style={s.errorText}>{state.errors.nama[0]}</p>
              )}
            </div>
            ...
            <div style={s.formGroup}>
              ...
              />
              {state?.errors?.no_hp && (
                <p style={s.errorText}>{state.errors.no_hp[0]}</p>
              )}
            </div>
          ...
          <div style={s.footer}>
            <p style={{ margin: 0, fontSize: "13px", color: "#6b7280" }}>
              Sudah punya akun? <a href="/login" style={{ color: "#16a34a", fontWeight: "600", textDecoration: "none" }}>Masuk di sini</a>
            </p>
          </div>
        </div>
      </div>
...
const s: Record<string, React.CSSProperties> = {
  page: { minHeight: "100vh", backgroundColor: "#f0fdf4", fontFamily: "'Niramit', sans-serif", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px" },
  container: { width: "100%", maxWidth: "460px" },
